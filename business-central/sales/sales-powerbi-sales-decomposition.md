...
The *Sales Decomposition* report breaks down sales metrics into their key contributing components, such as locations, item categories and and customer demographics. The goal is to help users identify trends, understand sales drivers, and make informed adjustments to strategies.
