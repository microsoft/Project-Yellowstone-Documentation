...
The *Key Sales Influencers* report includes the following KPIs and measures: 
...
The *Key Sales Influencers* report use data from the following tables in [!INCLUDE[prod_short](includes/prod_short.md)]
- Item
- Customer
- Item Category
- Value Entry
